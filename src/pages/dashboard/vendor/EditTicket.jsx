...
const EditTicket = () => {
  ...
  const fetchTicket = async () => {
    ...
    try {
      ...
      if (ticket.vendor._id !== user._id) {
        toast.error('Not authorized to edit this ticket');
      ...
      if (ticket.verificationStatus === 'rejected') {
        toast.error('Cannot edit rejected tickets');
        navigate('/dashboard/vendor/my-tickets');
        return;
      }

      // Format date for input
      const formattedDate = new Date(ticket.departureDate).toISOString().split('T')[0];
  ...
  return (
    <div className="max-w-4xl">
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Edit Ticket</h1>
